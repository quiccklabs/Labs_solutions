...
<h1 style="color: #2F80ED;">🚀 BigQuery Core Challenge Lab </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/60366?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/228AA4g9do4" target="_blank" style="margin: 10px;">
...
```bash
export TASK_1_DATASET_NAME=

export TASK_1_SINK_NAME=

export TASK_2_TABLE_NAME=

export TASK_3_DATASET_NAME=

export TASK_3_VIEW_1=

export TASK_4_TABLE_NAME=
```
<br/>


```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/BigQuery%20Core%20Challenge%20Lab/quicklab.sh
...
```
SELECT *
FROM `PROJECT_ID.TASK_3_DATASET_NAME.cloudaudit_googleapis_com_activity_*`
WHERE protopayload_auditlog.serviceName = 'bigquery.googleapis.com'
```

<p style="font-size: 15px; color: #555;"><i>👉 Run this on Cloud shell.</i></p>

```bash
bq query --use_legacy_sql=false "
CREATE OR REPLACE TABLE ${TASK_1_DATASET_NAME}.${TASK_4_TABLE_NAME}
PARTITION BY TradeDate
CLUSTER BY Symbol AS
FROM \`${TASK_1_DATASET_NAME}.${TASK_2_TABLE_NAME}\`;"
```

<p style="font-size: 18px; margin-top: 0px;">👉 Follow the Video for Task 5.</p> 
