...
<h1 style="color: #2F80ED;">🚀 Use APIs to Work with Cloud Storage </br> Challenge Lab | ARC125 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/65991?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/x81wKPqhXLE" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Use%20APIs%20to%20Work%20with%20Cloud%20Storage%20Challenge%20Lab/quicklabarc125.sh
sudo chmod +x quicklabarc125.sh
./quicklabarc125.sh
```
