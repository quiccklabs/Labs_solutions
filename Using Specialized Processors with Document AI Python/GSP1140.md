...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/JfIvQEA8doc)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Using%20Specialized%20Processors%20with%20Document%20AI%20Python/quicklabgsp1140.sh
sudo chmod +x quicklabgsp1140.sh
./quicklabgsp1140.sh
```
