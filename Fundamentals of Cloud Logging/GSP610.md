...
<h1 style="color: #2F80ED;">🚀 Fundamentals of Cloud Logging  | GSP610 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/10911?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/VMdqMOIpaoA" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Fundamentals%20of%20Cloud%20Logging/quicklabgsp610.sh
sudo chmod +x quicklabgsp610.sh
./quicklabgsp610.sh
```
