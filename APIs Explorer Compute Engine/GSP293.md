...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/xQSOaNs0Hao)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/APIs%20Explorer%20Compute%20Engine/quicklabgsp293.sh
sudo chmod +x quicklabgsp293.sh
./quicklabgsp293.sh
```
