...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/K6v0aPc2jFk)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Using%20Prometheus%20for%20Monitoring%20on%20Google%20Cloud%20Qwik%20Start/quicklabgsp1024.sh
sudo chmod +x quicklabgsp1024.sh
./quicklabgsp1024.sh
```
