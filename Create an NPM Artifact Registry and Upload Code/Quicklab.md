...
<h1 style="color: #2F80ED;">🚀 Create an NPM Artifact Registry and Upload Code </h1>
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Create%20an%20NPM%20Artifact%20Registry%20and%20Upload%20Code/quicklab.sh
