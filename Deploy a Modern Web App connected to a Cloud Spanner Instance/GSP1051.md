...
<h1 style="color: #2F80ED;">🚀 Deploy a Modern Web App connected to a Cloud Spanner Instance | GSP1051 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/54356?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/S4BzUqUAlsE" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/master/Deploy%20a%20Modern%20Web%20App%20connected%20to%20a%20Cloud%20Spanner%20Instance/quicklabgsp1051.sh
sudo chmod +x quicklabgsp1051.sh
./quicklabgsp1051.sh
```
...
<p style="font-size: 15px; color: #555;"><i>Now run this command.</i></p>
