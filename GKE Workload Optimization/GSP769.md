...
<h1 style="color: #2F80ED;">🚀 GKE Workload Optimization  | GSP769 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/course_templates/655/labs/503746" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/olu6McAT1MQ" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/GKE%20Workload%20Optimization/quicklabgsp769.sh
sudo chmod +x quicklabgsp769.sh
./quicklabgsp769.sh
```
