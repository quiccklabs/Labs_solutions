...
<h1 style="color: #2F80ED;">🚀 Using Role-based Access Control in Kubernetes Engine  | GSP493 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/5156?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/N1MizshvWUI" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Using%20Role%20based%20Access%20Control%20in%20Kubernetes%20Engine/quicklabgsp493.sh
sudo chmod +x quicklabgsp493.sh
./quicklabgsp493.sh
```
