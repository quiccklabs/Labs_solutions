...
POST https://dev-compute.sandbox.googleapis.com/compute/beta/projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/healthChecks
{
  "checkIntervalSec": 5,
  "description": "",
  "healthyThreshold": 2,
  "name": "my-ilb-health-check",
  "region": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION",
  "tcpHealthCheck": {
    "port": 80,
    "proxyHeader": "NONE"
  },
...
POST https://compute.googleapis.com/compute/v1/projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/backendServices
{
  "backends": [
    {
      "balancingMode": "CONNECTION",
      "failover": false,
      "group": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/zones/$ZONE_1/instanceGroups/instance-group-1"
    },
    {
      "balancingMode": "CONNECTION",
      "failover": false,
      "group": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/zones/$ZONE_2/instanceGroups/instance-group-2"
    }
  ],
  "connectionDraining": {
    "drainingTimeoutSec": 300
  ...
  "failoverPolicy": {},
  "healthChecks": [
    "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/healthChecks/my-ilb-health-check"
  ],
  "loadBalancingScheme": "INTERNAL",
  "logConfig": {
    "enable": false
  ...
  "name": "my-ilb",
  "network": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/global/networks/my-internal-app",
  "protocol": "TCP",
  "region": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION",
  "sessionAffinity": "NONE"
}

POST https://compute.googleapis.com/compute/v1/projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/forwardingRules
{
  "IPAddress": "10.10.30.5",
  "IPProtocol": "TCP",
  "allowGlobalAccess": false,
  "backendService": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/backendServices/my-ilb",
  "description": "",
  "ipVersion": "IPV4",
  "loadBalancingScheme": "INTERNAL",
  "name": "my-ilb-forwarding-rule",
  ...
  "region": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION",
  "subnetwork": "projects/qwiklabs-gcp-01-1ba3f6dc3b90/regions/$REGION/subnetworks/subnet-b"
}