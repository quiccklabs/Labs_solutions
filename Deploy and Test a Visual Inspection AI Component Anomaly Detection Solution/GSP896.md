...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/fGhlCASM4QM)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Deploy%20and%20Test%20a%20Visual%20Inspection%20AI%20Component%20Anomaly%20Detection%20Solution/quicklabgsp896.sh
```
...
```bash
sudo chmod +x quicklabgsp896.sh
```
