...
<h1 style="color: #2F80ED;">🚀 Deploy a static site with Caddy V2 on Google Cloud Run </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/125086?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/9puKG0PN01U" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Deploy%20a%20static%20site%20with%20Caddy%20V2%20on%20Google%20Cloud%20Run/quicklab.sh
