...
<h1 style="color: #2F80ED;">🚀 Build an AI-Powered Interview Question Generator using Gemini </h1>
...
<a href="https://youtu.be/_E7LciSQf58" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Build%20an%20AI-Powered%20Interview%20Question%20Generator%20using%20Gemini/quicklab.sh
source quicklab.sh
```
