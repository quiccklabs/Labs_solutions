...
<h1 style="color: #2F80ED;">🚀 BigQuery: Qwik Start - Console | GSP072 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/1145?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/x4BgsUVXKCc" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/BigQuery%20Qwik%20Start%20Console/quicklabgsp072.sh
sudo chmod +x quicklabgsp072.sh
./quicklabgsp072.sh
```
...
<p style="font-size: 15px; color: #555;"><i>👉 Task 6 need to perform manually.</i></p>
