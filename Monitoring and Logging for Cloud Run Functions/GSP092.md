...
<h1 style="color: #2F80ED;">🚀 Monitoring and Logging for Cloud Run Functions | GSP092 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/1833?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/YjOGW3ADK4Q" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Monitoring%20and%20Logging%20for%20Cloud%20Run%20Functions/quicklabgsp092.sh
