...
<h1 style="color: #2F80ED;">🚀 Arcade Hero: Building Blocks Artifact Registry II | ARC1208 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/124583?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/I-gcpDghlT4" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Arcade%20Hero/quicklabarc1208.sh
sudo chmod +x quicklabarc1208.sh
./quicklabarc1208.sh
```
