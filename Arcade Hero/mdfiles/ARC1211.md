...
<h1 style="color: #2F80ED;">🚀 Arcade Hero: Building Blocks Artifact Registry V | ARC1211 </h1>
...
<a href="https://youtu.be/pGlZQ2ZJr30" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Arcade%20Hero/quicklabarc1211.sh
sudo chmod +x quicklabarc1211.sh
./quicklabarc1211.sh
```
