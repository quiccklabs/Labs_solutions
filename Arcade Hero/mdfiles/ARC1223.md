...
<h1 style="color: #2F80ED;">🚀 Arcade Hero: Building Blocks Cloud Run functions IV | GSP1223 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/124590?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/5rppw_o97mc" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Arcade%20Hero/quicklabarc1223.sh
sudo chmod +x quicklabarc1223.sh
./quicklabarc1223.sh
```
