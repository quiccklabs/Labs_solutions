...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/GRn7HDC465o)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/SingleStore%20on%20Google%20Cloud/quicklabgsp1096.sh
sudo chmod +x quicklabgsp1096.sh
./quicklabgsp1096.sh
```
