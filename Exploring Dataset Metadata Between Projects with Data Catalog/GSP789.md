...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/XnzNh6hqSYw)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Exploring%20Dataset%20Metadata%20Between%20Projects%20with%20Data%20Catalog/quicklabgsp789.sh
```
...
```bash
sudo chmod +x quicklabgsp789.sh
```
