...
<h1 style="color: #2F80ED;">🚀 Deploy a Static Site with Nginx on Google Cloud Run using Artifact Registry </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/125091?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/VchLV07lQYQ" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Deploy%20a%20Static%20Site%20with%20Nginx%20on%20Google%20Cloud%20Run%20using%20Artifact%20Registry/quicklab.sh
