...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/fPhVrXNKslg)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Create%20a%20Streaming%20Data%20Lake%20on%20Cloud%20Storage%20Challenge%20Lab/quicklabarc110.sh
sudo chmod +x quicklabarc110.sh
./quicklabarc110.sh
```
