...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/cOvz0tQW63w)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/master/Dataproc%20Qwik%20Start%20Command%20Line/quicklabgsp104.sh
sudo chmod +x quicklabgsp104.sh
./quicklabgsp104.sh
```
