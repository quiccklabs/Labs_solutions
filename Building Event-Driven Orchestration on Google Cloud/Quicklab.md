...
# 🚀 Building Event-Driven Orchestration on Google Cloud | [Lab Link](https://www.cloudskillsboost.google/catalog_lab/5215)

### 🔗 **Solution Video:** [Watch Here ](https://youtu.be/Y-TZ-xlTOBc)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/master/Building%20Event-Driven%20Orchestration%20on%20Google%20Cloud/quicklab.sh
