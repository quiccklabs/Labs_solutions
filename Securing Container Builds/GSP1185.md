...
### 🔗 **Solution Video:** [Watch Here](https://youtu.be/_bqlK8_UeMk)
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Securing%20Container%20Builds/quicklabgsp1185.sh
```
...
```bash
sudo chmod +x quicklabgsp1185.sh
```
