...
<h1 style="color: #2F80ED;">🚀  User Authentication: Identity-Aware Proxy | GSP499 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/5562?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/wcV5btNHNRg" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/User%20Authentication%20IdentityAware%20Proxy/quicklabgsp499.sh
sudo chmod +x quicklabgsp499.sh
./quicklabgsp499.sh
```
