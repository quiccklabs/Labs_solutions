...
<h1 style="color: #2F80ED;">🚀 Fraud Detection on Financial Transactions with Machine Learning on Google Cloud | GSP774 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/17976?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/lGTjt5SZeag" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Fraud%20Detection%20on%20Financial%20Transactions%20with%20Machine%20Learning%20on%20Google%20Cloud/quicklabgsp774.sh
sudo chmod +x quicklabgsp774.sh
./quicklabgsp774.sh
```
