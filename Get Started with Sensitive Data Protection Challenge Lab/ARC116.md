...
<h1 style="color: #2F80ED;">🚀  Get Started with Sensitive Data Protection </br> Challenge Lab | ARC116 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/64782?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/VXGyBf3FPuM" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Get%20Started%20with%20Sensitive%20Data%20Protection%20Challenge%20Lab/quicklabarc116.sh
sudo chmod +x quicklabarc116.sh
./quicklabarc116.sh
```
...
- Now Open Sensitive Data Protection <a href="https://console.cloud.google.com/security/sensitive-data-protection/landing?referrer=search&inv=1&invt=AbyRbg" target="_blank" style="margin: 20px; padding-top:500px">
  <img src="https://img.shields.io/badge/Sensitive_data_protection-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Launch Cloud Shell" style="margin: 20px; padding-top:500px">
</a>
