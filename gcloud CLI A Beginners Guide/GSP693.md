...
<h1 style="color: #2F80ED;">🚀 gcloud CLI: A Beginner's Guide | GSP693 </h1>
...
<a href="https://youtu.be/K_CZ9of_QBA" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/gcloud%20CLI%20A%20Beginners%20Guide/quicklabgsp693.sh
sudo chmod +x quicklabgsp693.sh
./quicklabgsp693.sh
```
