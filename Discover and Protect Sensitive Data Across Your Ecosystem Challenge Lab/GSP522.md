...
<h1 style="color: #2F80ED;">🚀 Discover and Protect Sensitive Data Across Your Ecosystem Challenge Lab | GSP522 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/109502?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/n3WmrPLTKqw" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Discover%20and%20Protect%20Sensitive%20Data%20Across%20Your%20Ecosystem%20Challenge%20Lab/quicklabgsp522.sh
sudo chmod +x quicklabgsp522.sh
./quicklabgsp522.sh
```
...
<h3>📓 Run this on Jupyter Terminal:</h3>

```bash
rm deidentify-model-response-challenge-lab-v1.0.0.ipynb

curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Discover%20and%20Protect%20Sensitive%20Data%20Across%20Your%20Ecosystem%20Challenge%20Lab/deidentify-model-response-challenge-lab-v1.0.0.ipynb
```
