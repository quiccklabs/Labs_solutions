...
<h1 style="color: #2F80ED;">🚀 Create a Container Artifact Registry and Upload Code </h1>
...
<a href="https://youtu.be/is6SQE4HFYw" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Create%20a%20Container%20Artifact%20Registry%20and%20Upload%20Code/quicklab.sh
