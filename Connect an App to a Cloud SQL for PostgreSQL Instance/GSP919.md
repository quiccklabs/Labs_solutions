...
<h1 style="color: #2F80ED;">🚀 Connect an App to a Cloud SQL for PostgreSQL Instance | GSP919 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/57387?parent=catalog" target="_blank" style="margin: 10px;">
...
<p style="font-size: 15px; color: #555;">
  <i>👉 When prompted, enter the password: 
    <b style="font-size: 54px; color: #000;">supersecret!</b>
  </i>
</p>
...
DB_USER="postgres"
DB_NAME="gmemegen_db"
gcloud sql connect $INSTANCE_NAME --user=$DB_USER --quiet << EOF \c $DB_NAME SELECT * FROM meme; EOF
```
