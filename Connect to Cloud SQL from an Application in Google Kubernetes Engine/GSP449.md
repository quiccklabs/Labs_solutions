...
<h1 style="color: #2F80ED;">🚀 Connect to Cloud SQL from an Application in Google Kubernetes Engine | GSP449 </h1>


<br/>

<a href="https://www.cloudskillsboost.google/focuses/5625?parent=catalog" target="_blank" style="margin: 10px;">
  <img src="https://img.shields.io/badge/Access_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white" alt="Access Lab">
</a>

<a href="https://youtu.be/CEZbu7VolBQ" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Connect%20to%20Cloud%20SQL%20from%20an%20Application%20in%20Google%20Kubernetes%20Engine/quicklabgsp449.sh
sudo chmod +x quicklabgsp449.sh
./quicklabgsp449.sh
```
