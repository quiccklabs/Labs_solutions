...
<h1 style="color: #2F80ED;">🚀 Configure Cloud Storage Bucket for Website Hosting using gsutil </h1>
...
<a href="https://youtu.be/ABGhwBQp4I0" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Configure%20Cloud%20Storage%20Bucket%20for%20Website%20Hosting%20using%20gsutil/quicklab.sh
source quicklab.sh
```
