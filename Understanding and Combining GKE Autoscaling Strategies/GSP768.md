...
<h1 style="color: #2F80ED;">🚀 Understanding and Combining GKE Autoscaling Strategies| GSP768 </h1>
...
<a href="https://youtu.be/U02031AWDfU" target="_blank" style="margin: 10px;">
...
```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Understanding%20and%20Combining%20GKE%20Autoscaling%20Strategies/task1.sh
sudo chmod +x task1.sh
./task1.sh
```

<p style="font-size: 15px; color: #555;"><i>👉 Check the score for Task 2 & then only move ahead with next commands.</i></p>

<hr style="border: none; height: 1px; background: #ddd; margin: 30px 0;">

```bash
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/refs/heads/master/Understanding%20and%20Combining%20GKE%20Autoscaling%20Strategies/task2.sh
